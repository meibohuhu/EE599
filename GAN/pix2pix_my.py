...
# settings
Config ={}
Config['ROOT_PATH_INPUT']='/home/ec2-user/final/filter_org_20.hdf5'
Config['ROOT_PATH_MASK']='/home/ec2-user/final/filter_msk_20.hdf5'
...
def Discriminator(n_filters=16, dropout=0.1, batchnorm=True):
    ...
    outputs = Dense(84,activation='sigmoid')(c9)
...
generator.save('g_model_W_20epo_WBCEadd.h5')
